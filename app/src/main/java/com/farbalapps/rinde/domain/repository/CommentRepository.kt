...
interface CommentRepository {
    ...
    suspend fun addComment(postId: String, comment: Comment, imageUri: String?): Result<Unit>
    suspend fun addReply(commentId: String, reply: Reply, imageUri: String?): Result<Unit>
